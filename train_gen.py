...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="GEN_at_once_not_random", help="name of this experiment")
    parser.add_argument("--seed", type=int, default=42, help="set the seed for reproducibilityt")
    parser.add_argument("--num-episodes", type=int, default=5000, help="number of episodes for training")
    parser.add_argument("--num-epochs", type=int, default=4, help="number of epochs to train the networks per episode")
    parser.add_argument("--batch-size", type=int, default=256, help="batch size of the training")
