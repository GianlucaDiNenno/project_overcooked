...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="GEN_exp", help="the name of this experiment")
    ...
    parser.add_argument("--loading_file", type=str, default="GEN_exp_increasing_difficulty", help="name of the file from which to load the weights")
    parser.add_argument("--saving_file", type=str, default="GEN_exp_increasing_difficulty_1", help="name of the file in which to save the weights")
...
if __name__ == "__main__":
    ...
    for episode in range(1,NUM_EPISODES+1):
        ...
        while not done:
            ...
            #collecting information about the episode for each timestep
